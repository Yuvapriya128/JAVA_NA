...
public interface EmployeeRepo extends JpaRepository<Employee,Long> {
    @Query("""
select new org.example.springdatajpademo.ProjectEmplyoee.dto.EmployeeResponseDTO(e.id,e.name,e.designation,e.department,e.email) from Employee e where e.department= :department
""")
